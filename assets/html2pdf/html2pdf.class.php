...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_format           = 'legal';        // page format : A4, A3, ...
         ...
         */
        public function __construct($orientation = 'P', $format = 'legal', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 8))
        {
            ...
            $this->_setDefaultMargins($marges[0], $marges[1], $marges[1], $marges[1]);
            $this->_SetMargins(6.20, 6.20, 6.20);
            $this->_marges = array();
...
'.$content.'
        ...
        protected function _tag_open_H1($param, $other = 'h1')
        {
            ...
            $this->parsingCss->value['margin']['t'] = $this->parsingCss->ConvertToMM('12px');
            $this->parsingCss->value['margin']['b'] = $this->parsingCss->ConvertToMM('12px');
        ...
        protected function _tag_open_TD($param, $other = 'td')
        {
            ...
            $marge = array();
            $marge['t'] = $this->parsingCss->value['padding']['t']+0.2*HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['t']['width'];
            $marge['r'] = $this->parsingCss->value['padding']['r']+0.2*HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['r']['width'];
            $marge['b'] = $this->parsingCss->value['padding']['b']+0.2*HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['b']['width'];
            $marge['l'] = $this->parsingCss->value['padding']['l']+0.2*HTML2PDF::$_tables[$param['num']]['cellspacing']+$this->parsingCss->value['border']['l']['width'];
