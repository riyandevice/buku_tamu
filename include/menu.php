...
<div class="user-panel">
  ...
  <img style="margin-left:30px" src="images/logo.png" width="140" height="120" >
      <h5 style="color:white; font-size: 16px; text-align: center; ">SMKS</h5>
      <h5 style="color:white;  font-size: 16px; text-align: center; ">Untung Surapati Pasuruan</h5>
  </div>
...
<li><a href="./logout.php"><i class="fa fa-dashboard"></i>Keluar Applikasi</a></li>
</ul>
